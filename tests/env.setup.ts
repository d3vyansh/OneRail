...
// application module is required. Several modules (routes/user.ts,
// controllers/pnr_alerts.ts) read process.env at require-time, so these
// values must exist before app.ts is first imported anywhere.
